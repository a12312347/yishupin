define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'artist_order/index' + location.search,
                    //add_url: 'artist_order/add',
                    //edit_url: 'artist_order/edit',
                    //del_url: 'artist_order/del',
                    multi_url: 'artist_order/multi',
                    table: 'order',
                }
            });
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate, formatter: Table.api.formatter.operate,buttons:[
                            {
                                ...
                                text:'发货',
                                title:'发货',
                                classname:'btn-xs btn btn-warning btn-ajax',
