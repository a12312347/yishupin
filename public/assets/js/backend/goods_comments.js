define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'goods_comments/index' + location.search,
                    add_url: 'goods_comments/add',
                    edit_url: 'goods_comments/edit',
                    del_url: 'goods_comments/del',
                    multi_url: 'goods_comments/multi',
